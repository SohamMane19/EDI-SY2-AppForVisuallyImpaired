...
public class MainActivity3 extends AppCompatActivity {
        ...
        textToSpeech = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    textToSpeech.speak("Opening the calculator......  just tap on the screen and say what you want to calculate", TextToSpeech.QUEUE_FLUSH, null);
    ...
    public boolean onKeyDown(int keyCode, @Nullable KeyEvent event) {
        if(keyCode == KeyEvent.KEYCODE_VOLUME_UP){
            textToSpeech.speak("just swipe right and say what you want", TextToSpeech.QUEUE_FLUSH, null);

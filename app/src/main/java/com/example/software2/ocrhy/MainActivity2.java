...
public class MainActivity2 extends AppCompatActivity {
        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    Toast.makeText(MainActivity2.this, "swipe right and say yes to read and say no to return back", Toast.LENGTH_SHORT).show();
                    textToSpeech.speak("swipe right and say yes to read and say no to return back", TextToSpeech.QUEUE_ADD, null);
                }
            }
        });
        mVoiceInputTv = (TextView) findViewById(R.id.textView);
    ...
    private void textRecognizer() {
        ...
        textToSpeech.speak(" Tap on the screen take a picture of any text", TextToSpeech.QUEUE_FLUSH, null);
